...
<!--more-->先下载自动安装脚本：https://chrome.richardlloyd.org.uk/install_chrome.sh

然后使用gedit编辑install—chrome.sh，使用find功能查找并将  
其中的https://omahaproxy.appspot.com改为https://dl.google.com/linux/direct  
...
添加如下内容：
    ...
    gpgkey=https://dag.wieers.com/rpm/packages/RPM-GPG-KEY.dag.txt
